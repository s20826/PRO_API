...
namespace Application.WizytaUslugi.Commands
{
    ...
    public class WizytaUslugaKlientQueryHandler : IRequestHandler<AddWizytaUslugaCommand, int>
    {
        private readonly IKlinikaContext context;
        private readonly IHash hash;
        private readonly IWizytaRepository wizytaRepository;
        public WizytaUslugaKlientQueryHandler(IKlinikaContext klinikaContext, IHash _hash, IWizytaRepository _wizytaRepository)
        {
