...
namespace Domain.Entities
{
    public class Pacjent : AuditableEntity, IHasDomainEvent
    {
        ...
        public Pacjent(uint idPacjent, uint idOsoba, string nazwa, string gatunek, string rasa, string masc, string plec, DateTime dataUrodzenia, float waga, bool agresywne)
        {
            IdPacjent = idPacjent;
            IdOsoba = idOsoba;
            Nazwa = nazwa;
